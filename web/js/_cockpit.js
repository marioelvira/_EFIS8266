	...
	{	
		$.getJSON(jsondir, function(jsonData) {
			...
			$.each(jsonData, function(index, obj) {
				...
				if (obj.param == "airSpeedtxt")
					$("#airspeedtxt").html(obj.value);
				...
				if (obj.param == "altimetertxt")
					$("#altimetertxt").html(obj.value);
				...
				if (obj.param == "turnAngletxt")
					$("#turn_coordinatortxt").html(obj.value);
				
				if (obj.param == "heading")
					heading.setHeading(obj.value);
				if (obj.param == "headingtxt")
					$("#headingtxt").html(obj.value);

				if (obj.param == "vario")
					variometer.setVario(obj.value);
				if (obj.param == "variotxt")
					$("#variometertxt").html(obj.value);
			})
